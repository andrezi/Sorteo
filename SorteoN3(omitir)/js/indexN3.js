...
window.onload = function () {
    ...
    var tipAnm = basil.get('pirotecniaN3') + "";
    switch (tipAnm) {
        case "1":
            AnimarGano();
            break;
    ...
    var gnold = basil.get("ganadoresSorteo");
    ganadores = gnold ? gnold : [];

    var mostrarGan = basil.get("MostrarGanadores");
    if (mostrarGan == "1") {
        for (var indice = 0; indice < ganadores.length; indice++) {
            $("#ganadores").append("<span class='copaPeque' style='font-size: 36px;'><i class='fa fa-trophy' style='color:gold;' aria-hidden='true'></i>&nbsp;<span>" + ganadores[indice] + "</span></span>");
            $("#ganadores").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
        }
    }
};
...
function GenerarSiguienteGanador() {
    ...
    $("#copa").html("");
    $("#nCentenas").css("margin-left", "28%");
    switch (basil.get("ImgFondoRifa")) {
        case "premioTv":
        ...
        case "fondoGanar":
            ...
            $("#nCentenas").text("0").css("color", "#fff");
            break;
        case "fondoRifaRegalo":
            $("#nUnidades").text("0").css("color", "#fff");
            $("#nDecenas").text("0").css("color", "#fff");
            $("#nCentenas").text("0").css("color", "#fff");
            break;
        case "fondoRifaSerpentinasBrillantina":
            $("#nUnidades").text("0").css("color", "#fff");
            $("#nDecenas").text("0").css("color", "#fff");
            $("#nCentenas").text("0").css("color", "#fff");
            break;
        case "fondoRifaSerpentinasOpaca":
            $("#nUnidades").text("0").css("color", "#650465");
            $("#nDecenas").text("0").css("color", "#650465");
            $("#nCentenas").text("0").css("color", "#650465");
            break;
        default:
            $("#nUnidades").text("0").css("color", "#fff");
            $("#nDecenas").text("0").css("color", "#fff");
    ...
    var iniRIng = basil.get('rangoIN3');
    if (iniRIng)
        iniRIng = parseInt(iniRIng);
    else
        iniRIng = 1;

    var finRIng = basil.get('rangoFN3');
    if (finRIng)
            ...
            case 3:
                ...
                switch (basil.get("ImgFondoRifa")) {
                    case "premioTv":
                        ...
                        break;
                    case "fondoGanar":
                        $("#nUnidades").css("color", "blueviolet");
                        break;
                    case "fondoRifaRegalo":
                        $("#nUnidades").css("color", "#161b16");
                        break;
            ...
            case 1:
                ...
                switch (basil.get("ImgFondoRifa")) {
                    case "premioTv":
                        ...
                        break;
                    case "fondoGanar":
                        $("#nCentenas").css("color", "blueviolet");
                        break;
                    case "fondoRifaRegalo":
                        $("#nCentenas").css("color", "#161b16");
                        break;
...
function SetWinner() {
    ...
    $("#nCentenas").css("margin-left", "auto");
    $("#ganadores").append("<span class='copaPeque' style='font-size: 36px;'><i class='fa fa-trophy' style='color:gold;' aria-hidden='true'></i>&nbsp;<span>" + ganadores[ganadores.length - 1] + "</span></span>");
    $("#ganadores").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
    $("#getQuote").removeClass("disabled");
    $("#getQuote").removeAttr("disabled", "disabled");
    AdministrarAnimacionPirotecnia();
    basil.set("ganadoresSorteo", ganadores);
}
...
function AnimarGano3() {
    ...
    sndAdrs = new Audio("../lib/firework.mp3");
    sndAdrs.muted = true;
...
function AnimarGano2() {// Code by Matheus Lin
